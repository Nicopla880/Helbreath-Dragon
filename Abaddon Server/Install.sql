...
-- Dumping database structure for International
CREATE DATABASE IF NOT EXISTS `International` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `International`;


-- Dumping structure for table International.account_database
CREATE TABLE IF NOT EXISTS `account_database` (
  ...
  `WorldServer` varchar(20) NOT NULL DEFAULT 'International',
  PRIMARY KEY (`Name`),
...
-- Dumping structure for table International.bank_item
...
-- Dumping structure for table International.cash_transactions
...
-- Dumping structure for table International.char_database
...
-- Dumping structure for table International.guild
...
-- Dumping structure for table International.guild_item
...
-- Dumping structure for table International.guild_member
...
-- Dumping structure for table International.ipblocked
...
-- Dumping structure for table International.item
...
-- Dumping structure for table International.macblocked
...
-- Dumping structure for table International.mail
...
-- Dumping structure for table International.paypal_cart_info
...
-- Dumping structure for table International.paypal_payment_info
...
-- Dumping structure for table International.paypal_subscription_info
...
-- Dumping structure for table International.skill
...
-- Dumping structure for table International.stats
